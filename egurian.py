...
def RDVC3(X, exte, inte, classe, n_PC):
  ...
  for ex in range(len(lista_grupos_ext)):
    ...
    lista_grupos_int = sep_sort(X.loc[treino], 7, classe)
    ...
    V = Vh.T
    scores_treino = U[:,0:PC_usada+1]*s[0:PC_usada+1]
    ...
    matriz_de_parametros = [sensibilidade, especificidade, acuracia, PPV, NPV]
  ...
  return(AUC_medias, historico_erros, historico_AUC, n_pcs, lista_parametros, lista_confusao)